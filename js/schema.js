...
export const COLLECTIONS = {
  ...
  devices: {
    ...
    fields: [
      ...
      loc,
      { k: 'revealId', label: 'Tactacam Reveal camera ID', t: 'text', show: (r) => r.type === 'camera', help: 'Filled in automatically when the relay syncs this camera.' },
      { k: 'batteryPct', label: 'Battery % (reported)', t: 'num', show: (r) => !!r.revealId },
      { k: 'signal', label: 'Signal bars (reported)', t: 'num', show: (r) => !!r.revealId },
  ...
  photos: {
    ...
    fields: [
      ...
      loc,
      { k: 'temp', label: 'Temperature (°F)', t: 'num', show: (r) => r.source === 'reveal' },
      { k: 'moon', label: 'Moon phase', t: 'text', show: (r) => r.source === 'reveal' },
